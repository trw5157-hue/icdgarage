    ...
    <div className="min-h-screen bg-black text-white" data-testid="manager-dashboard">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-4 md:py-6 space-y-4 md:space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full max-w-md grid-cols-2 bg-zinc-800 p-1 rounded-lg">
            <TabsTrigger 
              value="jobs" 
              data-testid="jobs-tab" 
              className="text-sm rounded-md data-[state=active]:bg-red-600 data-[state=active]:text-white transition-all"
            >
              Jobs
            </TabsTrigger>
            <TabsTrigger 
              ...
              <CardContent className="p-0">
                <div className="overflow-x-auto">
                  <table className="w-full min-w-[700px]">
                    <thead>
                      <tr className="border-b border-zinc-800 text-left">
                        <th className="pb-3 px-4 md:px-6 text-gray-400 font-medium text-sm">Invoice No.</th>
                        <th className="pb-3 px-4 md:px-6 text-gray-400 font-medium text-sm">Customer</th>
                        <th className="pb-3 px-4 md:px-6 text-gray-400 font-medium text-sm hidden md:table-cell">Vehicle</th>
                        <th className="pb-3 px-4 md:px-6 text-gray-400 font-medium text-sm hidden lg:table-cell">Date</th>
                        <th className="pb-3 px-4 md:px-6 text-gray-400 font-medium text-sm">Amount</th>
                        <th className="pb-3 px-4 md:px-6 text-gray-400 font-medium text-sm">Actions</th>
                      </tr>
                    </thead>
                    <tbody>
                      {invoices.map(({ job, invoice }) => (
                        <tr key={invoice.id} className="border-b border-zinc-800 hover:bg-zinc-800/50">
                          <td className="py-4 px-4 md:px-6 font-mono text-xs md:text-sm">{invoice.invoice_number}</td>
